...
| Click restart after finishing a round | Game should reset without needing a browser refresh | Game would not restart correctly unless I reloaded the page | none |
| Keep guessing wrong until score drops | Score should stay within a reasonable minimum or reset properly | Score dropped below zero to `-30` | none |
